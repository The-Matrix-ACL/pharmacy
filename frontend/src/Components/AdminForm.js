...
function AdminForm() {
  ...
  return (
    <div className="PharmaAdminAddAdminPage" style={{width: 1440, height: 1026, position: 'relative', background: 'white'}}>
  <div className="Botbar" style={{width: 1493, height: 131, left: -53, top: 937, position: 'absolute'}}>
  ...
  <div className="Login" style={{width: 500.02, height: 468, left: 451.98, top: 271, position: 'absolute'}}>
    <div className="Login" style={{width: 463, height: 59, left: 13.02, top: 409, position: 'absolute'}}>
      <button className="SignUp" style={{
          ...
          }} onClick={handleSubmit}>Add Admin</button>    </div>
    <div className="Formbounds" style={{width: 500.02, height: 397, left: 0, top: 0, position: 'absolute'}}>
      <div className="Line1" style={{width: 500, height: 0, left: 0, top: 53, position: 'absolute', border: '5px #4685FF solid'}}></div>
      <div className="Line2" style={{width: 500, height: 0, left: 0.02, top: 397, position: 'absolute', border: '5px #4685FF solid'}}></div>
      <div className="AddANewAdmin" style={{width: 312, height: 36, left: 188.02, top: 0, position: 'absolute', textAlign: 'right', color: '#4685FF', fontSize: 36, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Add A New Admin</div>
    </div>
    <div className="Password" style={{width: 473, height: 83, left: 13.02, top: 242, position: 'absolute'}}>
      ...
      <input
          ...
          />    </div>
    <div className="Username" style={{width: 473, height: 83, left: 13.02, top: 112, position: 'absolute'}}>
      <div className="Rectangle5" style={{width: 473, height: 83, left: 0, top: 0, position: 'absolute', background: 'white', borderRadius: 20, border: '7px #4685FF solid'}} />
      <input
            type="text"
            name="username"
  ...
  <div className="Username" style={{width: 234, height: 29, left: 485, top: 344, position: 'absolute', color: 'rgba(69.91, 132.84, 255, 0.50)', fontSize: 36, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Username</div>
  <div className="Password" style={{width: 176, height: 25, left: 485, top: 474, position: 'absolute', color: 'rgba(69.91, 132.84, 255, 0.50)', fontSize: 36, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Password</div>
</div>
  );
}
