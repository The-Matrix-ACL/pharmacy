...
console.log(localStorage)
  ...
  <div className="Navbar" style={{width: "100%", height: 446, left: -243, top: -89, position: 'absolute'}}>
    ...
    <div className="Signup" style={{width: 133, height: 59, left: 1484, top: 178, position: 'absolute'}}>
      ...
      <div className="SignUp" style={{width: 133, left: 0, top: 12, position: 'absolute', textAlign: 'center', color: '#4685FF', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Log Out</div>
    </div>
  </div>
  <div className="Group3" style={{width: 1335, height: 625, left: 36, top: 212, position: 'absolute', marginBottom: "10%"}}>
    ...
    <div className="Line4" style={{width: 1335, height: 0, left: 0, top: 625, position: 'absolute', border: '5px #4685FF solid'}}></div>
    <div className="ViewAllMedicine" style={{width: 602, height: 56, left: 23, top: 0, position: 'absolute', color: 'black', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>View All Medicine</div>
  </div>
      <div className="Rectangle15" style={{width: 497, height: 40, left: 360, top: 220, position: 'absolute', background: 'white', borderRadius: 10, border: '1px #4685FF solid'}} />
  <div className="Rectangle16" style={{width: 317, height: 40, left: 1054, top: 220, position: 'absolute', background: 'white', borderRadius: 10, border: '1px #4685FF solid'}} />
  <div className="Rectangle17" style={{width: 41, height: 40, left: 1330, top: 220, position: 'absolute', background: 'white', borderRadius: 10, border: '1px #4685FF solid'}} />
  <div className="SearchMedicines" style={{width: 320, height: 37, left: 376, top: 220, position: 'absolute', color: 'rgba(0, 0, 0, 0.20)', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Search Medicines</div>
  <div style={{width: 304, height: 40, left: 1330, top: 220, position: 'absolute'}}><span style= {{color: 'rgba(0, 0, 0, 0.28)', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>                         </span><span style= {{ color: '#4685FF', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word' }}>▼</span>
  </div>
  ...
  textAlign: "left", }}>Price</th>
                  <th style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>Ingredients</th>
                  <th style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>Usage</th>
                  <th style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>description</th>
                  <th style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>Picture</th>
                  <th style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>Amount</th>
                  <th style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  ...
  textAlign: "left", }}>{Meds.name}</td>
              <td style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>{Meds.price}</td>
              <td style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>{Meds.ingredients}</td>
              <td style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>{Meds.usage}</td>
              <td style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>{Meds.description}</td>
              <td style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>{Meds.picture}</td>
              <td style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
  textAlign: "left", }}>{Meds.amount}</td>
              <td style={{border: "3px #4685FF solid",height: "70px", padding: "15px",
