...
function Adminhome() {
  ...
  return (
    <div className="PharmaAdminDashboardPage" style={{width: 1440, height: 1016, position: 'relative', background: 'white'}}>
    ...
    <div className="Navbar" style={{width: 1683, height: 446, left: -243, top: -89, position: 'absolute'}}>
      ...
      <div className="Logo" style={{width: 1290, height: 446, left: 0, top: 0, position: 'absolute'}}>
        ...
        <div className="PharmacyAdmin" style={{width: 618, height: 86, left: 672, top: 177, position: 'absolute', color: 'white', fontSize: 60, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Pharmacy - Admin</div>
        <div className="Logobtn" style={{width: 719, height: 175, left: 243, top: 89, position: 'absolute'}} />
      </div>
      <div className="Signup" style={{width: 133, height: 59, left: 1484, top: 178, position: 'absolute'}}>
        <div className="Rectangle4" style={{width: 131, height: 59, left: 2, top: 0, position: 'absolute', background: 'white', borderRadius: 18}} />
        <button className="SignUp" style={{width: 133, left: 0, top: 12, position: 'absolute', textAlign: 'center', color: '#4685FF', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}onClick={handleLogout}>Log Out</button>
      </div>
      <a href="/adminchangepassword" className="Signup" style={{width: 359, height: 59, left: 1260, top: 102, position: 'absolute'}}>
    ...
    <div className="Navigation" style={{width: 1014, height: 370, left: 212, top: 414, position: 'absolute'}}>
      ...
      <div className="Btn" style={{width: 441, height: 59, left: 518, top: 184, position: 'absolute'}}>
        <div className="Rectangle4" style={{width: 434.37, height: 59, left: 6.63, top: 0, position: 'absolute', background: 'white', borderRadius: 18}} />
        <div className="SignUp" style={{width: 441, left: 0, top: 12, position: 'absolute', textAlign: 'center', color: '#4685FF', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>View All Pharmacists</div>
      </div>
      <a href="/viewpatients" className="Btn" style={{width: 441, height: 59, left: 56, top: 184, position: 'absolute'}}>
        <div className="Rectangle4" style={{width: 434.37, height: 59, left: 6.63, top: 0, position: 'absolute', background: 'white', borderRadius: 18}} />
        <div className="SignUp" style={{width: 441, left: 0, top: 12, position: 'absolute', textAlign: 'center', color: '#4685FF', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>View All Patients</div>
      </a>
      <a href="/viewPharmacistRequests" className="Btn" style={{width: 441, height: 59, left: 518, top: 103, position: 'absolute'}}>
        <div className="Rectangle4" style={{width: 434.37, height: 59, left: 6.63, top: 0, position: 'absolute', background: 'white', borderRadius: 18}} />
        <div className="SignUp" style={{width: 441, left: 0, top: 12, position: 'absolute', textAlign: 'center', color: '#4685FF', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Pharmacist Join Requests</div>
      </a>

      <a href="/addAdmin" className="Btn" style={{width: 441, height: 59, left: 56, top: 103, position: 'absolute'}}>
        <div className="Rectangle4" style={{width: 434.37, height: 59, left: 6.63, top: 0, position: 'absolute', background: 'white', borderRadius: 18}} />
        <div className="SignUp" style={{width: 441, left: 0, top: 12, position: 'absolute', textAlign: 'center', color: '#4685FF', fontSize: 32, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Add An Adminstrator</div>
        </a>
      </div>
    
    <div className="WelcomeAdminName" style={{width: 890, height: 104, left: 47, top: 216, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 64, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Welcome!</div>
  </div>
  );
}
