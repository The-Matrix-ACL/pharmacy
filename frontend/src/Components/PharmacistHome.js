...
const handleLogout = () => {
  ...
  return (
    <div className="PharmaPharmacistDashboardPage" style={{width: 1440, height: 1016, position: 'relative', background: 'white'}}>
  ...
  <div className="Navbar" style={{width: 1683, height: 446, left: -243, top: -89, position: 'absolute'}}>
    ...
    <div className="Logo" style={{width: 1342, height: 446, left: 0, top: 0, position: 'absolute'}}>
      <img className="Acllogo1" style={{width: 923, height: 446, left: 0, top: 0, position: 'absolute'}} src={acllogo} />
      <div className="PharmacyPharmacist" style={{width: 670, height: 86, left: 672, top: 177, position: 'absolute', color: 'white', fontSize: 60, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Pharmacy - Pharmacist</div>
      <div className="Logobtn" style={{width: 719, height: 175, left: 243, top: 89, position: 'absolute'}} />
    </div>
    <a href="/pharmacistchangepassword" className="Signup" style={{width: 359, height: 59, left: 1262, top: 104, position: 'absolute'}}>
  ...
  <div className="WelcomePharmacistName" style={{width: 890, height: 104, left: 47, top: 216, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 64, fontFamily: 'Josefin Sans', fontWeight: '400', wordWrap: 'break-word'}}>Welcome!</div>
</div>
